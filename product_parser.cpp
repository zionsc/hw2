...
{
    Product *nBook = new Book(categoryID(), prodName_, price_, qty_, isbn_, author_);
    return nBook;
}
...
{
    Product *nClothing = new Clothing(categoryID(), prodName_, price_, qty_, size_, brand_);
    return nClothing;
...
{
    Product *nMovie = new Movie(categoryID(), prodName_, price_, qty_, genre_, rating_);
    return nMovie;
}
